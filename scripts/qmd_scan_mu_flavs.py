...
from model.analysis import get_kmesh, get_quantum_metric_component, deriv_fermi_distrib, sym_decomp_cond
...
def plot_flavors(mu_vals, contributions, labels):
    ...
    plt.tight_layout()
    plot_path = figures_dir / "scan_nlt_qmd_flavors.png"
    plt.savefig(plot_path, dpi=300)
    print(f"Plot saved to {plot_path}")
    plt.show()

if __name__ == "__main__":
    mu_vals = np.linspace(-0.2, 0.2, 400)
